...
export default function Team() {
  ...
  if (loading) {
    return (
      <section id="team" className="public-section py-10 sm:py-14">
  ...
  return (
    <SectionWrapper id="team" className="section-shell py-10 sm:py-14 lg:py-20">
      <div className="mx-auto max-w-7xl px-5 sm:px-6 lg:px-8">
        <div className="mb-6 grid gap-5 sm:mb-8 lg:grid-cols-[minmax(0,1.05fr)_minmax(260px,0.95fr)] lg:items-end">
        ...
        <AnimatedGrid className="grid grid-cols-1 gap-[var(--card-gap)] md:grid-cols-2 xl:grid-cols-4">
